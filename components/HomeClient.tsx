        ...
        <div style={{ position: 'relative', width: '100%', height: '92vh', minHeight: 540, maxHeight: 860, overflow: 'hidden' }}>
          ...
          <div className="hero-inner" style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '0 64px 64px' }}>
            <div className="hero-content" style={{ maxWidth: 1140, margin: '0 auto', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 40 }}>
              <div>
                <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.6)', letterSpacing: '0.14em', textTransform: 'uppercase', fontWeight: 500, marginBottom: 16 }}>{hero.hero_tagline}</p>
              ...
              <div className="hero-right" style={{ flexShrink: 0, maxWidth: 280, paddingBottom: 8 }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                  <Link href={hero.hero_button_url || '/kategorien'} style={{ background: 'rgba(255,255,255,0.12)', border: '1px solid rgba(255,255,255,0.3)', backdropFilter: 'blur(8px)', color: '#fff', padding: '10px 22px', borderRadius: 6, fontSize: 12, fontWeight: 500, letterSpacing: '0.06em', fontFamily: "'DM Sans', sans-serif", textDecoration: 'none' }}>{hero.hero_button_text}</Link>
                </div>
              </div>
            </div>
          </div>
